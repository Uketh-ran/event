...
const RomanticThemeDecoration = () => {
  const navigate = useNavigate();

  return (
    <div className="anniversary-service-page text-white text-center py-5">
      <Container>
        <h2 className="fw-bold mb-4">💞 Romantic Theme Decoration</h2>
        <img
          src={themeImg}
          alt="Romantic Theme Decoration"
          className="img-fluid rounded shadow mb-4 imgs"
        />
        <p className="fs-5">
...
export default RomanticThemeDecoration;
