...
const ElectionCampains= () => {
  const navigate = useNavigate();
  return (
    <div className="wedding-page text-white">
      <Container className="py-5 text-center">
        <div className="d-flex align-items-center justify-content-center mb-4">
          <h1 className="text-light"> <FaBullhorn/>Election Campaigns</h1>
        </div>
        <img
          src={themeImg}
        ...
        <Button onClick={() => navigate("/politicalparty-function")} variant="warning" className="mt-3">⬅ Back to Political Events</Button>
      </Container>
    </div>
  );
};

export default ElectionCampains;
